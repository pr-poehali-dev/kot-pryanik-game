...
function Help() {
  const steps = [
    { icon: 'ArrowLeftRight', title: 'Полосы движения', text: 'Пряник бежит вперёд по дороге. Меняй полосу стрелками, кнопками или свайпом.' },
    { icon: 'ArrowUp', title: 'Прыжок', text: 'Жми «Прыжок», пробел или свайп вверх, чтобы перепрыгнуть препятствие 🚧.' },
    { icon: 'Coins', title: 'Собирай золото 🪙', text: 'Беги по полосе с монетами. Набери цель уровня, чтобы победить.' },
    ...
    { icon: 'ShieldAlert', title: 'Препятствия 🚧', text: 'Перепрыгивай их или объезжай по другой полосе. Щит спасёт от удара!' },
  ];
  return (
